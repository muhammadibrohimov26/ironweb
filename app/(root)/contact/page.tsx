		...
		<div className='max-w-6xl mx-auto'>
			...
			<div className='grid grid-cols-2 max-md:grid-cols-1 gap-4 mt-6'>
				<div className='flex flex-col'>
					<h1 className='text-4xl font-creteRound'>Contact ironblog</h1>
					...
					<div className='mt-12 flex items-center gap-3'>
						...
						<p className='text-sm'> <a href="mailto:muhammadibrohimov0306@gmail.com">muhammadibrohimov0306@gmail.com</a> </p> 
					</div>
